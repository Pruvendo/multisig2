...
Definition LocalState0000L := [( XHMap (string*nat) ( uint256)) : Type; ( XHMap string nat ) : Type ] .
...
Definition LocalState0001L := [( XHMap (string*nat) ( uint8)) : Type; ( XHMap string nat ) : Type ] .
...
Definition LocalState0011L := [( XHMap (string*nat) ((TransactionLRecord))) : Type; ( XHMap string nat ) : Type ] .
...
Definition LocalState0100L := [( XHMap (string*nat) ( uint32)) : Type; ( XHMap string nat ) : Type ] .
...
Definition LocalState0101L := [( XHMap (string*nat) ((TransactionLRecord[]))) : Type; ( XHMap string nat ) : Type ] .
...
Definition LocalState0110L := [( XHMap (string*nat) ((CustodianInfoLRecord[]))) : Type; ( XHMap string nat ) : Type ] .
...
Definition LocalState0111L := [( XHMap (string*nat) ( optional  ( uint256 ))) : Type; ( XHMap string nat ) : Type ] .
...
Definition LocalState1000L := [( XHMap (string*nat) ( optional  ((TransactionLRecord) ))) : Type; ( XHMap string nat ) : Type ] .
...
Definition LocalState1001L := [( XHMap (string*nat) ( optional  (tuple ( uint64)( (TransactionLRecord) ) ))) : Type; ( XHMap string nat ) : Type ] .
...
Definition LocalState1010L := [( XHMap (string*nat) ( boolean)) : Type; ( XHMap string nat ) : Type ] .
...
Definition LocalState1011L := [( XHMap (string*nat) ( uint128)) : Type; ( XHMap string nat ) : Type ] .
...
Definition LocalState1100L := [( XHMap (string*nat) ( optional  ( uint8 ))) : Type; ( XHMap string nat ) : Type ] .
...
Definition LocalState1101L := [( XHMap (string*nat) ( uint256[])) : Type; ( XHMap string nat ) : Type ] .
...
#[global, program] Instance LocalStateField0000 : LocalStateField ( uint256).
Next Obligation. 
...
#[global, program] Instance LocalStateField0001 : LocalStateField ( uint8).
Next Obligation. 
...
#[global, program] Instance LocalStateField0011 : LocalStateField ((TransactionLRecord)).
Next Obligation. 
...
#[global, program] Instance LocalStateField0100 : LocalStateField ( uint32).
Next Obligation. 
...
#[global, program] Instance LocalStateField0101 : LocalStateField ((TransactionLRecord[])).
Next Obligation. 
...
#[global, program] Instance LocalStateField0110 : LocalStateField ((CustodianInfoLRecord[])).
Next Obligation. 
...
#[global, program] Instance LocalStateField0111 : LocalStateField ( optional  ( uint256 )).
Next Obligation. 
...
#[global, program] Instance LocalStateField1000 : LocalStateField ( optional  ((TransactionLRecord) )).
Next Obligation. 
...
#[global, program] Instance LocalStateField1001 : LocalStateField ( optional  (tuple ( uint64)( (TransactionLRecord) ) )).
Next Obligation. 
...
#[global, program] Instance LocalStateField1010 : LocalStateField ( boolean).
Next Obligation. 
...
#[global, program] Instance LocalStateField1011 : LocalStateField ( uint128).
Next Obligation. 
...
#[global, program] Instance LocalStateField1100 : LocalStateField ( optional  ( uint8 )).
Next Obligation. 
...
#[global, program] Instance LocalStateField1101 : LocalStateField ( uint256[]).
Next Obligation. 
